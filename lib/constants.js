...
// Unités proposées pour les INGRÉDIENTS d'une recette. « Sachet » en est
// exclu à dessein : en cuisine on dose à la cuillère, et le contenu d'un
// sachet varie d'une marque à l'autre. Il reste dans UNITS parce qu'à
// l'achat, un sachet est bien ce qu'on met dans le caddie.
export const RECIPE_UNITS = UNITS.filter(u => u !== 'sachet')
